 ...
 * |            |     |     |     |     |     |     |     |  ,  |  .  |  /  |     |           |  |     |     |     |  |  |
 * `------------------------------------------------------------------------------------------'  |-----------------|  |  |
 *             |LGui | CAPS|                      Space                   |Alt |F24 |            |  ←  |  ↓  |  →  | ←─  |
 *             |     | LOCK|                                              |    |    |            |     |     |     |     |
 *             `--------------------------------------------------------------------'            `-----------------------' 
 */
    [0] = UNIMAP_X1( \
    F1, F2, F3, F4, F5,  PGUP,PGDN, F11,F12,                          HOME,PSLS,PAST,PMNS, \
    ESC, 1,  2,  3,  4, 5, 6, 7, 8, 9,  0,  MINS,  EQL, BSLS, BSPC,   P7,  P8,  P9,  PPLS, \
    TAB, Q,  W,  E,  R, T, Y, U, I, O,  P,  LBRC,  RBRC, DEL,  ENT,   P4,  P5,  P6,  PEQL, \
    LCTRL,  A,  S,  D,  F, G, H, J, K, L,  SCLN, QUOT, GRV,           P1,  P2,  P3,  PDOT, \
    FN0,   Z,  X,  C,  V, B, N, M, COMM, DOT, SLSH, SLSH,             P0,  UP,  PDOT,PENT, \
    LGUI, LCAP,                  SPC,                    LALT, FN1,   LEFT,DOWN,RIGHT      \
    ),
